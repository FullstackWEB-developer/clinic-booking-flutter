                            ...
                            child: Chip(
                              ...
                              label: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Text(_doctor.rate.toString(), style: Get.textTheme.bodyText2.merge(TextStyle(color: Get.theme.colorScheme.secondary, height: 1.4))),
                                ],
                              ),
                  ...
                  Wrap(
                    ...
                    children: List.generate(_doctor.specialities.length, (index) {
                      return Container(
                        ...
                        child: Text(_doctor.specialities.elementAt(index).name, style: Get.textTheme.caption.merge(TextStyle(fontSize: 10))),
                        decoration: BoxDecoration(
